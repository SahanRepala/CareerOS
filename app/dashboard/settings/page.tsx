        ...
        <Card className="shadow-card">
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-1.5">
              <Label htmlFor="interface-language" className="text-xs">Interface language</Label>
              <Select defaultValue="en">
                <SelectTrigger id="interface-language" className="rounded-lg">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-1.5">
              <Label htmlFor="resume-language" className="text-xs">Resume language</Label>
              <Select defaultValue="en">
                <SelectTrigger id="resume-language" className="rounded-lg">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
        ...
        <Card className="shadow-card">
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-1.5">
              ...
              <Input id="account-email" defaultValue="avery.mitchell@example.com" />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="account-password" className="text-xs">New password</Label>
              <Input id="account-password" type="password" placeholder="Leave blank to keep current" />
            </div>
