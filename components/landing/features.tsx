    ...
    <section id="features" className="relative py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal>
          <SectionHeading
            align="center"
            eyebrow="One application, done right"
            title="Everything You Need To Submit One Winning Application"
            description="Every card below exists to increase your odds of getting an interview. Nothing else."
          />
        </Reveal>
